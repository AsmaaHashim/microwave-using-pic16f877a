...
static void (*TIMER0_CalL_Back_ptr)(void) = (void*)0 ;

static void (*CCP1_CalL_Back_ptr)(void) = (void*)0 ;

static void (*CCP2_CalL_Back_ptr)(void) = (void*)0 ;
...
void __attribute__((picinterrupt(("")))) ISR()
{
    ...
    if((*((volatile unint8*)0X0B) & (1 << 2)))
    {
          if(TIMER0_CalL_Back_ptr != (void*)0)
            {
    ...
    if((*((volatile unint8*)0X0C) & (1 << 2)))
    {
        if(CCP1_CalL_Back_ptr != (void*)0)
        {

            CCP1_CalL_Back_ptr();

            *((volatile unint8*)0X0C) &=~(1 << 2);
        }
    }



    if((*((volatile unint8*)0X0D) & (1 << 0)))
    {
        if(CCP2_CalL_Back_ptr != (void*)0)
        {

            CCP2_CalL_Back_ptr();

            *((volatile unint8*)0X0D) &=~(1 << 0);
